            ...
            <div className="flex flex-col md:flex-row gap-8 justify-evenly px-4">
                ...
                <div className="max-w-sm bg-black border border-gray-800 rounded-lg shadow-2xl dark:bg-white dark:border-gray-300 flex-1 custom-hover-project">
                    ...
                    <div className="p-5">
                        ...
                        <div className="flex justify-between">
                            <a href="https://github.com/sreeramss/Crypto-Currency-Dashboard" target='blank' className="inline-flex items-center px-3 py-2 text-sm font-medium text-white bg-black rounded-lg hover:bg-yellow-500">
                                View Code
                            </a>
                            <a href="https://crypto-currency-dashboard-vert.vercel.app" className="inline-flex items-center px-3 py-2 text-sm font-medium text-white bg-black rounded-lg hover:bg-yellow-500 ">
                            Live Demo
                            </a>
                        </div>
                    </div>
                ...
                <div className="max-w-sm bg-black border border-gray-800 rounded-lg shadow-2xl dark:bg-white dark:border-gray-300 flex-1 custom-hover-project">
                    ...
                    <div className="p-5">
                        ...
                        <div className="flex justify-between">
                            <a href="https://github.com/sreeramss/wallpaper-desktop" className="inline-flex items-center px-3 py-2 text-sm font-medium text-white bg-black rounded-lg hover:bg-yellow-500">
                                View Code
                            </a>
                            <a href="https://sreeramss.github.io/wallpaper-desktop/" className="inline-flex items-center px-3 py-2 text-sm font-medium text-white bg-black rounded-lg hover:bg-yellow-500">
                                Live Demo
                            </a>
                        </div>
                    </div>
                ...
                <div className="max-w-sm bg-black border border-gray-800 rounded-lg shadow-2xl dark:bg-white dark:border-gray-300 flex-1 custom-hover-project">
                    ...
                    <div className="p-5">
                        ...
                        <div className="flex justify-between">
                            <a href="https://github.com/sreeramss/YT-Subscribers" className="inline-flex items-center px-3 py-2 text-sm font-medium text-white bg-black rounded-lg hover:bg-yellow-500">
                            View Code
                            </a>
                            <a href="https://yt-subscribers-fed3.onrender.com/" className="inline-flex items-center px-3 py-2 text-sm font-medium text-white bg-black  rounded-lg hover:bg-yellow-500">
                            Live Demo
                            </a>
                        </div>
                    </div>
