...
function Home() {
  ...
  return (
    <section id='home' className='flex flex-col md:flex-row justify-center h-full md:py-28 md:mb-10'>
      <div className='md:w-1/2'>
        ...
        <div className=' flex flex-row px-12 -my-10 '>
          <a className='pr-10 hover:text-yellow-500' href="https://github.com/sreeramss"><FaGithub size={50} /></a>
          <a className='pr-10 hover:text-yellow-500' href="https://www.linkedin.com/in/sreeram-ss"><FaLinkedin size={50} /></a>
          <a className='hover:text-yellow-300' href="https://www.instagram.com/sreeram_s_s_"><FaInstagramSquare size={50} /></a>
        </div>
      </div>
