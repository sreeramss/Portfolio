      ...
      <div className="md:w-1/2">
        <div className="text-3xl lg:text-5xl px-10 py-36">
          ...
          <div style={{ paddingTop: "1rem" }}>
            <span className="py-6">
              I'm <span className="text-yellow-400 font-bold">Sree Ram</span>
            </span>
          </div>
          <br />
          <div style={{ paddingTop: "1rem" }}>
        ...
        <div className="flex flex-col lg:flex-row">
          <div className=" flex flex-row px-12 -my-10 ">
            <a
              className="pr-10 hover:text-yellow-400"
          ...
          <a href={Downloadpdf} download="Sreeram Resume.pdf">
            <div className="ml-16 mr-20 mt-28 lg:-mt-10 px-12 py-4 text-sm font-medium text-white bg-black rounded-3xl hover:bg-yellow-400 flex justify-between">
